export default {
  ...
  how_it_works: {
    title: 'Hoe werkt het?',
    steps: {
      1: 'Bestel 10 fysieke kaartjes via deze website',
      2: 'Verras iemand met een van deze kaartjes',
      3: 'Schrijf online een bericht met de code van die kaart',
      4: 'De ontvanger kan nu jouw bericht lezen!',
      5: 'Zal je een berichtje terug krijgen?',
    }
  },
  what_is_flatter: {
    title: 'Wat is flatter?',
  ...
  search: {
    title: 'Zoek jouw kaart',
    type_code: 'Typ jouw code...'
  },
  order: {
    title: 'Bestel jouw kaarten',
